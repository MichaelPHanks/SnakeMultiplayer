...
namespace Client
{
    public class AfterDeathView : GameStateView
    {
        ...
        // NOTE: There is a chance that this should be part of the gameplay view.
        // This would be easiest to keep the game running in the background.
        // Maybe this should be a separate class for rendering? We shall see
