    ...
    public class Renderer : Shared.Systems.System
    {
        ...
        public void update(TimeSpan elapsedTime, SpriteBatch spriteBatch, int gameWidth, int gameHeight, Texture2D backgroundImage)
        {
            ...
            spriteBatch.Draw(backgroundImage, new Rectangle(-(int)(position1.X % gameWidth),-(int)(position1.Y % gameHeight), gameWidth, gameHeight), Color.White);
                ...
                // Render the rest...
                spriteBatch.Draw(backgroundImage, new Rectangle(-(int)(position1.X % gameWidth) + gameWidth, -(int)(position1.Y % gameHeight) + gameHeight, gameWidth, gameHeight), Color.White);
                spriteBatch.Draw(backgroundImage, new Rectangle(-(int)(position1.X % gameWidth) + gameWidth, -(int)(position1.Y % gameHeight), gameWidth, gameHeight), Color.White);
                spriteBatch.Draw(backgroundImage, new Rectangle(-(int)(position1.X % gameWidth), -(int)(position1.Y % gameHeight) + gameHeight, gameWidth, gameHeight), Color.White);
